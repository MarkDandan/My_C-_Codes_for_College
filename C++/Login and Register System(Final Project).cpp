...
int main() {
    ...
    cout << "\t\t********************************************************************************\n"; Sleep(250);
    cout << "\t\t================================================================================\n"; Sleep(250);
    cout << "\t\t _________    __________   __________   ___    ____   ___________  ____________\n"; Sleep(250);
    cout << "\t\t/|  ___   |  /|  ____  |  /|  _____ |  /|  |  /|  |  /|  _____  |  ||  ______  |\n"; Sleep(250);
    cout << "\t\t|| |__/|__|  || |___/| |  || |___/| |  ||  |  ||  |  || |____/| |  ||__|   //  |\n"; Sleep(250);
    cout << "\t\t|| |  |/__/  || |___|| /  || |   || |  ||  |  ||  |  || |___|_| |      ___//  / \n"; Sleep(250);
    cout << "\t\t|| |  _____  ||   ___ \\   || |   || |  ||  |  ||  |  ||  _______|    ||___   | \n"; Sleep(250);
    cout << "\t\t|| | |__  _| ||  |--/| |  || |   || |  ||  |  ||  |  ||  |                \\\\  \\\n"; Sleep(250);
    cout << "\t\t|| |___|  |  ||  |  || |  || |___|| |  ||  |__||  |  ||  |         ____    \\\\  |\n"; Sleep(250);
    cout << "\t\t||________|  ||__|  ||_|  ||________|  ||_________|  ||__|         ||  |____|  |\n"; Sleep(250);
    cout << "\t\t|/________/  |/_/   |/_|  |/________/  |/________/   |/__/         ||__________|\n\n"; Sleep(250);
    cout << "\t\t********************************************************************************\n"; Sleep(250);
    cout << "\t\t================================================================================\n"; Sleep(250);
    cout << "\t\t================================================================================\n"; Sleep(250);
    cout << "\t\t################################################################################\n"; Sleep(250);
    cout << "\t\t*********** ESTORBA ## BOCO ## CANAWAY ## LINCOPENES ## BERINA *****************\n\t\t";
...
void house() {
    ...
    cout << "\t\t\t|     ||_____||    ||________||________|_____________L|      |" << endl;
    cout << "\t\t\t|     ||_|_|_||    ||________||________| | |  |  |  | |      |" << endl;
    cout << "\t\t\t|         {} ||    ||________||________|_|_|__|__|__|_|      |" << endl;
    cout << "\t\t\t|          {}|-----------------------------------------      |" << endl;
    cout << "\t\t\t|            |*----*|/       ||        ||            ||      |" << endl;
    cout << "\t\t\t|           /*----*|/        ||        ||            ||      |" << endl;
    cout << "\t\t\t|     *****/*----*|/*_**__**_||        ||            ||      |" << endl;
